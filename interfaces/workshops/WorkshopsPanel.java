...
import interfaces.workshops.createtheme.EditThemeDialog;
import tools.Pair;
import tools.Tools;
...
public class WorkshopsPanel extends Panel {
	...
	private void createTheme() {
		EditThemeDialog editThemeDialog = new EditThemeDialog(new Theme("", ""));
		int result;
		Theme theme;
		...
		if (treePath != null) {
			...
			if (path != null) {
				...
				if (!(theme instanceof Tip)) {
					editThemeDialog = new EditThemeDialog(theme);
...
//						this.removeTheme(theme);
	...
	private void removeTheme(Theme theme) {
		for (Theme _theme : this.getThemes()) {
