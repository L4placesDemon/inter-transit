...
public class AccountsManagementPanel extends Panel {
    ...
    public AccountsManagementPanel(AdminAccount adminAccount) {
    ...
    private void initComponents() {
        ...
        adminPanel.add(new JLabel(Tools.getImageIcon(
                this.getAdminAccount().getImage(),
                60,
                60
        )), BorderLayout.CENTER);
        adminPanel.add(new JLabel(
                this.getAdminAccount().getNickname(),
                JLabel.CENTER
        ), BorderLayout.SOUTH);
    ...
    public static void main(String[] args) {
        BinaryFileManager manager = new BinaryFileManager(Settings.ACCOUNTS_PATH_FILE);
        new AccountsManagementPanel((AdminAccount) manager.read().get(0)).showTestDialog();
    }
}
